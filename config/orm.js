...
var orm ={
  ...
  insertOne: function(table, columnArray, inputArray, callback){
    var qm = columnArray.map(()=> "?");
    var queryString = 'INSERT INTO ' + table + '(' + columnArray.join(",") + ') VALUES ('+qm.join(",")+')';

    connection.query(queryString, inputArray, function(err, data){
      if(err) throw err;
      callback(data);
    });
  },
